...
import { User, Mail, Lock, Phone, MapPin, Briefcase, DollarSign } from 'lucide-react';
...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    try {
      // Aquí deberías hacer la llamada a tu API de registro
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4 rounded-md">
            ...
            <div>
              <label htmlFor="dpi" className="block text-sm font-medium text-gray-400">
                DPI
              </label>
              <div className="relative mt-1">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
              ...
              {errors.dpi && (
                <p className="mt-1 text-sm text-red-500">{errors.dpi.message}</p>
              )}
            </div>
            ...
            <div>
              <label htmlFor="work" className="block text-sm font-medium text-gray-400">
                Ocupación
              </label>
              <div className="relative mt-1">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
              ...
              {errors.work && (
                <p className="mt-1 text-sm text-red-500">{errors.work.message}</p>
              )}
            </div>

            <div>
              <label htmlFor="monthlyIncome" className="block text-sm font-medium text-gray-400">
                Ingreso mensual
              </label>
              <div className="relative mt-1">
                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
