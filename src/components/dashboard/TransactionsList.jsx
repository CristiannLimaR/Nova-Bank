...
const TransactionsList = () => {
  ...
  // Ordenar transacciones por fecha y tomar las últimas 5
  ...
  return (
    <div className="rounded-lg bg-gray-900 p-5">
      ...
      <button 
        ...
        className="mt-4 w-full rounded-md bg-gray-800 py-2 text-sm font-medium text-white hover:bg-gray-700 transition-colors"
      >
