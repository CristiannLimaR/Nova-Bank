...
const UserForm = ({ user, onSave, onCancel, setEditingUser }) => {
  return (
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) => setEditingUser({ ...user, accountType: value })}
          >
            <SelectTrigger className="bg-gray-700 border-gray-600 text-white">
              <SelectValue placeholder="Selecciona un tipo de cuenta" />
            </SelectTrigger>
            <SelectContent className="bg-gray-800 border-gray-700">
              <SelectItem value="AHORRO" className="text-white hover:bg-gray-700">
                Cuenta de Ahorro
              </SelectItem>
              <SelectItem value="MONETARIA" className="text-white hover:bg-gray-700">
                Cuenta Monetaria
              </SelectItem>
            </SelectContent>
          </Select>
